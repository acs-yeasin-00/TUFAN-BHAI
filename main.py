#ONE & ONLY KING OF THE COMMITTIY :TUFANH CODEX
#INSTAGRAM : @TUFAN_codex076
#YOUTUBE : @TUFAN_codex076
#TELEGRAM : @TUFAN_codex076
        ...
        fields = {
            ...
            2: {   # data
                ...
                9: {    # field9 - player details
                    1: "[C][B][FF0000] TUFAN ON TOP",  # Nickname
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]TUFAN   
[FFD700]✨ Name on TIKTOK : [FFFFFF] its_me_tufan01 
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> TUFAN  ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "TUFAN", key, iv)
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "bot"):
                            print(f"Help command detected from UID: {uid} in chat type: {response.Data.chat_type}")

                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To TUFAN'S ʙᴏᴛ"
...
[FF69B4]━━━━━━━━━━━━[FF4500]"""
                            ...
                            footer ="""[00FFFA]╔═•══•════════════════•══•═╗
[FF1493]║ ⚡ [B][FFFF00]OENER INFO[FFFF00][/B] ⚡
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493] TUFAN
[32CD32]║ 🌐 TIKTOK       :: [32CD32]its_me_tufan0
[1E90FF]║ 🛠 Version      :: [1E90FF] V2
[00FFFA]╚═•══•════════════════•══•═╝"""
...
async def MaiiiinE():
    Uid , Pw = '4313693239','A30180347B9372C460DFE10835AD0CD6B40178C2F41E165DE53F641C5B915F83'
    ...
    os.system('clear')
    print(render('TUFANs', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 TUFAN BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
